...
export default function ProdukPage() {
  ...
  useEffect(() => {
    apiFetch('/api/products?module=apotek&limit=100')
  ...
  return (
    <AppLayout title="Stok Obat" subtitle="Manajemen inventaris obat">
      <div>
        <div className="flex items-center justify-between">
          <div>
            <h1 className="text-xl font-bold text-gray-900">Stok Obat</h1>
